...
<html lang="en">
  ...
  <body class="bg-light">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h4 class="mb-3">Silahkan Upload Foto Anda</h4>
          <form method="POST" action="aksi.php?act=upload_foto" enctype="multipart/form-data">
            <div class="row">

            <div class="col-md-12">
              <label for="address2"> Upload Foto <span class="text-muted">)*</span></label>
